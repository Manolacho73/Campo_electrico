...
#Se presentan a continuación un ejemplo de un modelo cuyos parámetros se controlan mediantes widgets
#Ejemplo de modelo para ajustar parámetros a mano

#Usando Widgets se pueden controlar los parámetros de un modelo y compararlo con los datos
